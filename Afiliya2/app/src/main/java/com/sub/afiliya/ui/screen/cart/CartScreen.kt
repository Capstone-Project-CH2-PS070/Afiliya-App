package com.sub.afiliya.ui.screen.cart
...
import com.silvy.subjetpack.ui.components.CartItem
            ...
            is UiState.Success -> {
                CartContent(
                    ...
                    onProductCountChanged = { rewardId, count ->
                        viewModel.updateOrderItems(rewardId, count)
                    },
...
fun CartContent(
    ...
    Column(
        ...
        LazyColumn(
            ...
            items(state.orderItems, key = { it.items.id }) { item ->
                CartItem(
                    rewardId = item.items.id,
                    image = item.items.image,
                    title = item.items.title,
                    totalPoint = item.items.requiredPoint * item.count,
                    count = item.count,
